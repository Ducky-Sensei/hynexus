...
This guide explains how to set up and use the monitoring and observability features in the frontend hynexus.
...
VITE_DATADOG_SERVICE=hynexus-fe
...
```env
VITE_OTEL_ENABLED=true
VITE_OTEL_SERVICE_NAME=hynexus-fe
