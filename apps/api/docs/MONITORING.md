...
This hynexus includes production-ready configurations for three observability platforms:
...
DATADOG_SERVICE_NAME=hynexus-service
...
| `DATADOG_SERVICE_NAME` | hynexus-service | Service identifier |
