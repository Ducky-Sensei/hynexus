...
This hynexus includes Swagger/OpenAPI documentation for all API endpoints. Swagger provides an interactive UI to explore and test your API during development.
...
This hynexus uses the **Swagger CLI Plugin** to **automatically generate most API documentation** from your code. This means you write **much less boilerplate**!
...
The hynexus uses Swagger decorators to document the API:
